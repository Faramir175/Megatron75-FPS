...
public class Turret : MonoBehaviour
{
    ...
    public float range,timeBetweenShots=.5f;
    ...
    void Update()
    {
        if (Vector3.Distance(transform.position,PlayerController.instance.transform.position)<range && PlayerController.instance.gameObject.activeInHierarchy)
        {
